...
<body>
	...
	<div id="main" class="container">
		...
		<div class='tudo'>
			...
			<!-- Container Principal -->
			<form action="fechar_Chamados.do" method="post" style ="margin-top: 30px">
			...
			<div class="row" align="center">
				<div class="table-responsive col-md-12">
					<button type="submit" class="btn btn-primary" id="buscar" name="acao" value="Buscar">Listar Chamados Abertos</button>	
			    </div>
			 </div>
		</form>
	</div>
